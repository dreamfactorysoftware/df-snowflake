...
- For **SPCS / Snowflake Native App** deployments, the connector uses the injected OAuth token and the Snowflake ODBC driver instead of `pdo_snowflake` — no username/password needed inside the container.
